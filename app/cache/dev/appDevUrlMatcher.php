    ...
    public function match($pathinfo)
    {
        ...
        if ($pathinfo === '/') {
            if ($this->context->getMethod() != 'POST') {
                $allow[] = 'POST';
                goto not__showcase_greeting;
            }

            return array (  '_controller' => 'Cupon\\OfertaBundle\\Controller\\SitioController::HolaMundoAction',  '_route' => '_showcase_greeting',);
        }
        not__showcase_greeting:
