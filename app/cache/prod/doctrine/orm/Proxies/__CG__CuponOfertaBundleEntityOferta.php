...
class Oferta extends \Cupon\OfertaBundle\Entity\Oferta implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'nombre', 'slug', 'descripcion', 'condiciones', 'foto', 'precio', 'descuento', 'fechaPublicacion', 'fechaExpiracion', 'compras', 'umbral', 'revisada', 'ciudad', 'tienda');
    }
